...
public class DocArtiste extends DataForm {
    ...
    public UUID getReponseId() { isNotEmpty(reponseId);return (UUID)convert(reponseId,UUID.class); }
    ...
    public Date getDatePeremption() { isNotEmpty(datePeremption);return (Date)convert(datePeremption,Date.class); }
