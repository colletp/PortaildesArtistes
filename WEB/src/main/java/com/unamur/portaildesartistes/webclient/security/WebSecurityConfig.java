...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    public void configure(final WebSecurity web) throws Exception {
        logger.error("configure WebSecurity");
        web.ignoring().antMatchers("/static/**");
    }
    @Override
    protected void configure(final AuthenticationManagerBuilder auth) throws Exception {
        logger.error("configure AuthenticationManagerBuilder");
    ...
    SimpleUrlAuthenticationSuccessHandler mySuccessHandler = new SimpleUrlAuthenticationSuccessHandler(); //MySavedRequestAwareAuthenticationSuccessHandler();
...
*/
        ...
        http.authorizeRequests().antMatchers("/", "/login","/login2", "/logout").permitAll();
        // /userInfo page requires login as ROLE_USER or ROLE_ADMIN.
        // If no login, it will redirect to /login page.
        http.authorizeRequests().antMatchers("/userInfo","/gestionUtilisateur","/gestionUtilisateur/*")
        .authenticated()
        ...
        http.authorizeRequests().and().formLogin()//
            ...
            .loginProcessingUrl("/login2") // Submit URL
            .loginPage("/login")//
